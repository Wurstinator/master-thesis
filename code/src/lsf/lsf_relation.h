 ...
 */
EquivalenceRelation<automaton::state_t> LSFBaseRelation(const automaton::DPA& automaton, automaton::parity_label_t k);
 ...
 */
std::unordered_map<automaton::state_t, std::unordered_set<automaton::state_t>> LSFMergeClasses(const automaton::DPA& automaton, automaton::parity_label_t k);
 ...
 * @param k The priority parameter.
 */
void LSFPerformMerge(automaton::DPA* automaton, automaton::parity_label_t k);
