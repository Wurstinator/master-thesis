...
NAMES = ['schewe', 'fritzwilke', 'iterated_moore', 'path_refinement', 'threshold_moore', 'lsf']
PRETTY_NAMES = ['Schewe 10', 'Fritz & Wilke 06', 'Iterated Moore eq.', 'Path Refinement', 'Threshold Moore', 'LSF']
all_data = {
